...
{  
    ...
    public class Utility
    {
        ...
        {
            string file = File.ReadAllText(@"C:\Users\Admin\source\ahsan\ObjectOrientedPrograms\ObjectOrientedPrograms\Company Shares\CompanysShares.json");
            return file;
        }
        ...
        {
            File.WriteAllText(@"C:\Users\Admin\source\ahsan\ObjectOrientedPrograms\ObjectOrientedPrograms\Company Shares\CompanysShares.json", file);
        }
    }
}
