// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Pulse.cs" company="Bridgelabz">
...
namespace ObjectOrientedPrograms.Inventory_Management
{
    ...
    public class Pulse
    {
        ...
        public static void InsertPulse(string name, double weight, double price)
        {
            InventoryItems array = Utility.ReadJsonFile();
            Pulse obj = new Pulse();
            obj.Name = name;
        ...
        public static void DeletePulse()
        {
            ...
            int itemNumber = Utility.IsInteger(Console.ReadLine());
            array.Pulse.RemoveAt(itemNumber - 1);
            Utility.WriteJsonFile(array);
        }
    }
}
